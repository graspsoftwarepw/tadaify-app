...
| [TR-SHARED-004](requirements/technical/0004-tr-004-database-supabase-local-docker-on-port-band-44210-44219-dev.md) | MUST | Database: Supabase (local Docker on port-band 44210-44219; DEV/PROD via Supabase hosted). |
