...
- 2026-05-04 · cleanup: drop F-001 guest-mode + `guest_drafts` ENTIRELY (DEC-355=C) — landing FAQ "How fast can I launch?" answer reworded to remove guest-mode promise; `docs/specs/functional-spec.md` §3.1 tombstoned; routing table `tadaify.com/try` marked REMOVED; `docs/decisions/0048-drop-f001-guest-mode-signup-first.md` (DEC-355) added; U1 unit test + S1/S2 Playwright spec verify absence — Issue tadaify-app#184
