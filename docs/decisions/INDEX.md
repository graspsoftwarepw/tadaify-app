...
| DEC-037 | superseded by DEC-083 → DEC-279 | 4-tier flat structure: Free $0 / Creator $5/mo / Pro $15/mo / Business $49/mo. 0% platform fees on every tier forever. Superseded by DEC-083 ($8/$19) then DEC-279 ($7.99/$19.99), both 2026-04-28. | `specs/functional-spec.md` L21, L1355 |
...
| DEC-PRICELOCK-02 | locked 2026-04-25 (domain price part superseded by DEC-279) | $2/mo domain add-on universal across all tiers (domain price → $1.99/mo per DEC-279 2026-04-28). Pro tier simplified to 1 custom domain (was 3). Business: 10 included (was unlimited). Pro differentiator = 8 power features, not domain count. | `specs/functional-spec.md` L126, L1490 |
| DEC-083 | superseded same-day by DEC-279 (2026-04-28) | Pricing revised: Creator $8/mo, Pro $19/mo (superseded DEC-037 $5/$15). Superseded same-day by DEC-279. Rationale: DEC-274 user answer — align spec to rendered mockup at $8/$19. | `specs/functional-spec.md` §DEC-083 section |
| DEC-279 | locked 2026-04-28 | Final pricing: Creator $7.99/mo, Pro $19.99/mo, extra-domain add-on $1.99/mo. Supersedes DEC-083 + DEC-PRICELOCK-02 (domain price part). User directive — .99 pricing for landing/marketing copy alignment. | `specs/functional-spec.md` §DEC-279 section |
